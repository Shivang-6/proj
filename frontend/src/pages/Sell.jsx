  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden p-0 md:p-0">
          {/* Header */}
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 md:p-10">
            <h1 className="text-3xl md:text-4xl font-bold mb-2">Sell Your Product</h1>
            <p className="text-blue-100 text-lg">Reach thousands of students on campus. Create an attractive listing to sell faster!</p>
          </div>
